...
{
    public record ForgetPassword(string Email) : IRequest<bool>;

    public class ForgetPasswordHandler : IRequestHandler<ForgetPassword, bool>
    {
        ...
        public ForgetPasswordHandler(IUnitOfWork unitOfWork, IPasswordHasher<User> passwordHasher, IMediator mediator)
        {
        ...
        public async Task<bool> Handle(ForgetPassword request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    ToEmail = user.Email,
                    Subject = MailSubjectMessages.UserForgetPassword,
                    Body = emailBody
                };
